		...
		const SKINS = [
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-2": "rgba(26, 30, 42, 0.96)",
			...
			},
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-2": "rgba(22, 32, 34, 0.96)",
			...
			},
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-2": "rgba(30, 27, 44, 0.96)",
			...
			},
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-2": "rgba(36, 28, 20, 0.96)",
			...
			},
			{
				...
				tokens: {
					...
					"--dsw-alias-bg-layer-2": "rgba(22, 22, 28, 0.96)",
