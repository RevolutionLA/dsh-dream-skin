...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="../../docs/previews/mist.png"><img src="../../docs/previews/mist.png" width="230" alt="mist"/></a><br/><b>mist</b> · Чистая яркость</td>
...
| `mist` | 🧊 Чистая яркость | ясный светлый стеклянный вид, полупрозрачность + размытие |
